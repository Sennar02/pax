...
namespace pax
{
    ...
    View::cull(v4f64 bounds, v4u64 limits) const
    {
        ...
        return {
            pax_max(limits[0], (u64) pax_max(0, truncs[0])),
            pax_max(limits[1], (u64) pax_max(0, truncs[1])),
            pax_min(limits[2], (u64) pax_max(0, truncs[2])),
            pax_min(limits[3], (u64) pax_max(0, truncs[3])),
        };
    }
} // pax
